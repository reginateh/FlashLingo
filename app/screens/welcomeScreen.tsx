  ...
  return (
    <View className="w-full flex-1 justify-center items-center bg-[#B9CBB1]">
      ...
      <View className="flex-col justify-center items-center w-full">
        <Button bg="dg" size="md" text="Login" onPress={() => router.navigate("/screens/loginScreen")}/>
        <Button bg="dg" size="md" text="Create Account" onPress={() => router.navigate("/screens/signUpScreen")} />
      </View>
    </View>
  )
}
